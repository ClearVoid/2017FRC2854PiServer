 ...
 * driving.
 */
public class RobotDriveTank implements MotorSafety {
   ...
   *        motor.
   */
  public RobotDriveTank(final int leftMotorChannel, final int rightMotorChannel) {
   ...
   */
  public RobotDriveTank(final int frontLeftMotor, final int rearLeftMotor, final int frontRightMotor,
   ...
   */
  public RobotDriveTank(SpeedController leftMotor, SpeedController rightMotor) {
   ...
   *        the robot.
   */
  public RobotDriveTank(SpeedController frontLeftMotor, SpeedController rearLeftMotor,
